...
- [SQLPad](#sqlpad)
  ...
  - [Configuration](#configuration)
    ...
    - [Connection configuration](#connection-configuration)
      ...
      - [INI file](#ini-file)
      - [JSON file](#json-file)
      - [CrateDB (crate)](#cratedb-crate)
      - [Apache Drill (drill)](#apache-drill-drill)
      - [SAP Hana (hdb)](#sap-hana-hdb)
      - [MySQL (mysql)](#mysql-mysql)
      - [PostgreSQL (postgres)](#postgresql-postgres)
      - [PrestoDB (presto)](#prestodb-presto)
      - [MS SQL Server (sqlserver)](#ms-sql-server-sqlserver)
...
- [github - sqlpad](https://github.com/rickbergfalk/sqlpad)
- [website](https://rickbergfalk.github.io/sqlpad/)
