...
- [Information](#information)
  - [linuxserver/bookstack](#linuxserverbookstack)
  ...
  - [Updating Info](#updating-info)
    - [Via Docker Run/Create](#via-docker-runcreate)
    - [Via Docker Compose](#via-docker-compose)
    - [Via Watchtower auto-updater (especially useful if you don't remember the original parameters)](#via-watchtower-auto-updater-especially-useful-if-you-dont-remember-the-original-parameters)
